...
#escribir "1 bandeja paisa $16.000"
#escribir "2 ajiaco $12.000"
#escribir "sancocho $12.000"
#Leer numero
#resultado opcion==1
#escribir "ha elegido bandeja paisa. total: $16.000" 
#resultado opcion==2
#escribir"ha elegido ajiaco. total: $12.000"
#resultado opcion==3
...
print("1. Bandeja Paisa ($16.000)")
print("2. Ajiaco ($12.000)")
print("3. Sancocho ($12.000)")

opcion = int(input("Ingrese el número de su opción: "))
if opcion == 1:
        print("Ha elegido Bandeja Paisa. Total: $16.000")
elif opcion == 2:
        print("Ha elegido Ajiaco. Total: $12.000")
elif opcion == 3:
